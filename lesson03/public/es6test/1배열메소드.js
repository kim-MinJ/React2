...
//      ㄴnumbers1 배열을 조작한 결과(각 요소값으로 연산)한 결과
const numbers2 = numbers1.map(myFunction)

//map에서 numbers1의 요소를 하나씩 가져와서 myFunction에 넣어줌
// value 는 numbers1 배열의 각각 요소값 (value는 입력값). 요소의 값만 사용할 때 인자는 1개
//그러면 numbers2 = [45*2, 4*2, 9*2, 16*2, 25*2] 가 된다.
